...
export class SupplierComponent implements OnInit {
  suppliers: suppliers[] = []
  newdata: suppliers = { supplier_id: 0, supplierName: "", email: "", phone: 0, location: "", feedback: 0 }
  addeddata: suppliers = { supplier_id: 0, supplierName: "", email: "", phone: 0, location: "", feedback: 0 }
  ...
  addsupplier() {
    ...
    if (this.newdata.supplierName == "" || this.newdata.email == "" || this.newdata.phone == 0 || this.newdata.location == "" || this.newdata.feedback == 0) {
  ...
  updating(supplier: suppliers) {
    ...
    this.newdata.supplierName = supplier.supplierName;
